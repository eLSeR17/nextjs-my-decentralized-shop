# NextJS My Decentralized Shop



[Full Repo](https://github.com/eLSeR17/my-decentralized-shop)
...
```
git clone https://github.com/eLSeR17/nextjs-my-decentralized-shop
cd nextjs-my-decentralized-shop
yarn
yarn dev
```
...
1. Run your local blockchain with the shop code
...
Head over to your [localhost](http://localhost:3000) and add some items to your shop!
